...
/// <summary>
/// Script asociado al boton de volver al menu de seleccion de nivel.
/// Se encuentra en los menus del nivel.
/// Implementa la interfaz IPointerClickhandler
/// </summary>
public class ButtonMenuLM : MonoBehaviour, IPointerClickHandler
{
    #region Attributes
    ...
    /// <summary>
    /// Activa el boton del menu cuando finaliza la animacion del menu de nivel completado.
    /// </summary>
    ...
    {
        LevelManager.Instance.Raise_MenuButtonClick();
    }
    #endregion
}